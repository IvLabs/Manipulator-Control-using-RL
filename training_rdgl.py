...
env = gym.make('PointToRandomPoint-v0',mode='P',P_sens=1,P_max_force=300)
env = Monitor(env,'monitor_1609')
...
model.learn(13000000,callback=callback,reset_num_timesteps=False)

t = env.get_episode_rewards()
model.save("arm_1609_modeP")
del model


file_name = "rewards_1609.pkl"
